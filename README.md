...
- Deno
- Bun
- WebAssembly/WAT/WASI (C, C++, AssemblyScript, Bytecode Alliance Javy, Rust, Zig, Go)
- Bash
...
- Turn local local server on and off in browser for TTS streaming [`deno-server`](https://github.com/guest271314/native-messaging-espeak-ng/tree/deno-server)
